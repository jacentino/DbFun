...
-- Name: DbFunTests; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "DbFunTests" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'Polish_Poland.1250' LC_CTYPE = 'Polish_Poland.1250';


ALTER DATABASE "DbFunTests" OWNER TO postgres;
...
1	functional-data-access-with-dbfun	Functional data access with DbFun	Designing functional-relational mapper with F#	jacentino	2017-06-01 00:00:00	\N	\N
\.

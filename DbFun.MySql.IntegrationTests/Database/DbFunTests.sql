CREATE DATABASE `dbfuntest` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `userprofile` (
  ...
  `avatar` varbinary(4096) NOT NULL,
  PRIMARY KEY (`id`)
...
insert into blog (id, name, title, description, owner, createdAt) 
values (1, 'functional-data-access-with-sqlfun', 'Functional data access with SqlFun', 'Designing functional-relational mapper with F#', 'jacentino', '2017-05-28 21:35:00');
